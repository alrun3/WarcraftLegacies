...
internal static class JuggernautDeath
{
  ...
  {
    var powerGenerator1 = preplacedUnitSystem.GetUnit(UNIT_NPGR_POWER_GENERATOR_FEL, new Point(5511.9f, -29688.2f));
    var powerGenerator2 = preplacedUnitSystem.GetUnit(UNIT_NPGR_POWER_GENERATOR_FEL, new Point(5513.1f, -30467.4f));
    var inferJuggernaut1 = preplacedUnitSystem.GetUnit(UNIT_N066_INFERNAL_JUGGERNAUT_FEL_TOWER, new Point(4356.6f, -29397.8f));
    var inferJuggernaut2 = preplacedUnitSystem.GetUnit(UNIT_N066_INFERNAL_JUGGERNAUT_FEL_TOWER, new Point(4245.3f, -29863.1f));
    var inferJuggernaut3 = preplacedUnitSystem.GetUnit(UNIT_N066_INFERNAL_JUGGERNAUT_FEL_TOWER, new Point(4537.8f, -30988.1f));
    var inferJuggernaut4 = preplacedUnitSystem.GetUnit(UNIT_N066_INFERNAL_JUGGERNAUT_FEL_TOWER, new Point(4631.4f, -31433.0f));
