...
namespace MacroTools.Extensions
{
  ...
  public static class TriggerExtensions
  {
    ...
    /// </summary>
    public static void RegisterSharedChatEvent(this trigger whichTrigger, string chatMessageToDetect, bool exactMatchOnly)
    {
    ...
    public static void RegisterEnterRegions(this trigger whichTrigger, IEnumerable<Rectangle> regions, boolexpr? filter = null)
    {
    ...
    public static void RegisterLeaveRegions(this trigger whichTrigger, IEnumerable<Rectangle> regions, boolexpr? filter = null)
    {
      foreach (var region in regions)
        TriggerRegisterLeaveRegion(whichTrigger, region.Region, filter);
    }
